...
from .views import (
    ...
    PostReactionView, PostBookmarkView, MyBookmarksView, MyPostDeleteView,
    CommentListView, CommentCreateView, CommentUpdateDeleteView, CommentBestAnswerView, CommentReactionView,
...
urlpatterns = [
    ...
    path('<int:pk>/delete/', MyPostDeleteView.as_view(), name='post-mine-delete'),
